...
const KoosOne = ({nameList,list,backwardLink,forwardLink}) => {
  ...
  return (
    <Box sx={{ backgroundImage: 'linear-gradient(to top, lightblue, white)', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
      <ProgressBar selected={1} amount={[1,2,3,4,5]}/>
      <Typography sx={{marginTop:'10px'}}>First Name</Typography>
